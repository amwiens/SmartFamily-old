...
namespace SmartFamily.Gedcom.Data
{
    /// <summary>
    ...
    public static class StaticDateData
    {
        ...
        /// Not all of these are valid as many tags come from programs that do not obey the standards.
        /// Longer strings that match the start of shorter strings should be lised first (APT. before ABT).
        /// 
        /// Of particular note;
