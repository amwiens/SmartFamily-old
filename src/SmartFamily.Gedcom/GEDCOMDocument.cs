...
namespace SmartFamily.Gedcom
{
    ...
    public class GEDCOMDocument
    {
        ...
        {
            get => _familyRecords ?? (_familyRecords = _records.GetLinesByTag(GEDCOMTag.FAM));
        }

        public GEDCOMRecordList IndividualRecords
        {
            get => _individualRecords ?? (_individualRecords = _records.GetLinesByTag(GEDCOMTag.INDI));
        }

        public GEDCOMRecordList MultimediaRecords
        {
            get => _multimediaRecords ?? (_multimediaRecords = _records.GetLinesByTag(GEDCOMTag.OBJE));
        }

        public GEDCOMRecordList NoteRecords
        {
            get => _noteRecords ?? (_noteRecords = _records.GetLinesByTag(GEDCOMTag.NOTE));
        }
        ...
        {
            get => _repositoryRecords ?? (_repositoryRecords = _records.GetLinesByTag(GEDCOMTag.REPO));
        }

        public GEDCOMRecordList SourceRecords
        {
            get => _sourceRecords ?? (_sourceRecords = _records.GetLinesByTag(GEDCOMTag.SOUR));
        }

        public GEDCOMSubmissionRecord Submission
        {
            get => _records.GetLineByTag<GEDCOMSubmissionRecord>(GEDCOMTag.SUBN);
        }

        public GEDCOMRecordList SubmitterRecords
        {
            get => _submitterRecords ?? (_submitterRecords = _records.GetLinesByTag(GEDCOMTag.SUBM));
        }
        ...
        public void AddRecord(GEDCOMRecord record)
        {
            ...
            // clear the associated RecordList so it is refreshed next time around
        ...
        /// <summary>
        /// Save the GGEDCOM Document to a Text Writer.
        /// </summary>
        ...
        /// <summary>
        /// ToString creates a string representation of the GEDCOMDocument.
        /// </summary>
