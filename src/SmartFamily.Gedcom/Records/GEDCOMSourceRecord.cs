...
{
    /// <summary>
    /// The <see cref="GEDCOMSourceRecord"/> class models a GEDCOM Source Record.
    /// </summary>
    /// <remarks>
    ...
    public class GEDCOMSourceRecord : GEDCOMBaseRecord
    {
        ...
        /// <summary>
        /// Constructs a <see cref="GEDCOMSourceRecord"/> from a <see cref="GEDCOMRecord"/>.
        /// </summary>
        /// <param name="record">A <see cref="GEDCOMRecord"/>.</param>
        public GEDCOMSourceRecord(GEDCOMRecord record)
            : base(record)
        {
        }
        ...
        {
            get => ChildRecords.GetRecordData(GEDCOMTag.ABBR);
        }
        ...
        {
            get => ChildRecords.GetRecordData(GEDCOMTag.AUTH);
        }
        ...
        {
            get => ChildRecords.GetRecordData(GEDCOMTag.PUBL);
        }
        ...
        {
            get => ChildRecords.GetLineByTag<GEDCOMSourceRepositoryCitationStructure>(GEDCOMTag.REPO);
        }
        ...
        public string Text
        {
            get => ChildRecords.GetRecordData(GEDCOMTag.TEXT);
        }
