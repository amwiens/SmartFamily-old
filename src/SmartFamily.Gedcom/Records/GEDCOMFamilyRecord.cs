...
{
    /// <summary>
    /// The <see cref="GEDCOMFamilyRecord"/> Class models a Genealogical Family Record.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Constructs a <see cref="GEDCOMFamilyRecord"/>.
        /// </summary>
        /// <param name="id"></param>
        public GEDCOMFamilyRecord(string id)
            : this(new GEDCOMRecord(0, $"@F{id}@", "", "FAM", ""))
        {
        }

        /// <summary>
        /// Constructs a <see cref="GEDCOMFamilyRecord"/> from a <see cref="GEDCOMRecord"/>.
        /// </summary>
        /// <param name="record">A <see cref="GEDCOMRecord"/>.</param>
        public GEDCOMFamilyRecord(GEDCOMRecord record)
            : base(record)
        {
        }
        ...
        {
            get => ChildRecords.GetXRefIDs(GEDCOMTag.CHIL);
        }
        ...
        {
            get => ChildRecords.GetLinesByTags<GEDCOMEventStructure>(GEDCOMUtil.FamilyEventTags);
        }
        ...
        {
            get => ChildRecords.GetXRefID(GEDCOMTag.HUSB);
        }
        ...
        {
            get => ChildRecords.GetRecordData(GEDCOMTag.NCHI);
        }
        ...
        public string Wife
        {
            get => ChildRecords.GetXRefID(GEDCOMTag.WIFE);
        }
