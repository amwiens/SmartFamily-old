...
namespace SmartFamily.Gedcom.Structures
{
    ...
    public class GEDCOMEventStructure : GEDCOMStructure
    {
        ...
        /// <summary>
        /// Constructs a <see cref="GEDCOMEventStructure"/> from a <see cref="GEDCOMRecord"/>.
        /// </summary>
        /// <param name="record">A <see cref="GEDCOMRecord"/>.</param>
        public GEDCOMEventStructure(GEDCOMRecord record)
            : base(record)
        {
        }
        ...
        public GEDCOMEventStructure(GEDCOMRecord record, EventClass eventClass)
            : base(record)
        {
        ...
        public GEDCOMEventStructure(int level, string tag, string date, string place)
            : base(new GEDCOMRecord(level, "", "", tag, ""))
        {
        ...
        public string Age
        {
            get => ChildRecords.GetRecordData(GEDCOMTag.AGE);
        }
        ...
        {
            get => ChildRecords.GetRecordData(GEDCOMTag.AGNC);
        }
        ...
        public string Cause
        {
            get => ChildRecords.GetRecordData(GEDCOMTag.CAUS);
        }
        ...
        {
            get => ChildRecords.GetLineByTag<GEDCOMPlaceStructure>(GEDCOMTag.PLAC);
        }
