...
namespace SmartFamily.Gedcom.Tests.Common
{
    public class Util
    {
        ...
        public static GEDCOMHeaderRecord CreateHeaderRecord(string fileName)
        {
            ...
            record.FileName = $@"C:\Code\Mine\SmartFamily\src\tests\SmartFamily.Gedcom.Tests\TestFiles{fileName}.ged";
        ...
        public static GEDCOMIndividualRecord CreateIndividualRecord(int recordNo)
        {
            ...
            switch (recordNo)
            {
                ...
                default:
                    ...
                    name = new GEDCOMNameStructure($"{firstName} /{lastName}/", individual.Level + 1);
                    individual.Name = name;
                    break;
            }
