...
namespace SmartFamily.Core.Tests.Guards
{
    public sealed class UriTests : BaseTests
    {
        ...
        private const string HttpsUriString = "https://github.com/amwiens/smartfamily";

        private const string HttpUriString = "http://github.com/amwiens/smartfamily";

        private const string RelativeUriString = "amwiens/smartfamily";
