...
namespace SmartFamily.Core.Guards
{
    ...
    {
        /// <summary>
        /// Requires the argument value to have the specified host.
        /// </summary>
        ...
        /// <summary>
        /// Requires the argument value to not have the specified host.
        /// </summary>
        /// <param name="argument">The email address argument.</param>
        ...
        /// <summary>
        /// Requires the argument value to have one of the specified hosts.
        /// </summary>
        ...
        /// <summary>
        /// REquires the argument value to have none of the specified hosts.
        /// </summary>
        /// <typeparam name="TCollection">The type of the hosts collection.</typeparam>
        /// <param name="argument">The email address argument.</param>
        ...
        /// <summary>
        /// Requires the argument value to have a display name specified.
        /// </summary>
        /// <param name="argument">The email address argument.</param>
        /// <param name="message">
        ///     The factory to initialize the message of the exception that will be thrown if the
        ...
        /// <summary>
        /// Requires the argument value to not have a display name specified.
        /// </summary>
        /// <param name="argument">The email address argument.</param>
        /// <param name="message">
        ///     The factory to initialize the message of the exception that will be thrown if the
