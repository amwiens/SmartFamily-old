...
namespace SmartFamily.Core.Guards
{
    ...
    public static partial class Guard
    {
        ...
        /// <content>
        /// Contains the compatibility preconditions.
        /// </content>
        ...
        /// <summary>
        /// Provides cached utilities for <typeparamref name="T"/>.
        /// </summary>
        ...
        private static class TypeInfo<T>
        {
            ...
            /// <summary>
            /// Initializes <see cref="CanBeInitializedFrom"/>.
            /// </summary>
            /// <returns>
            ///     A function that determines whether the specified object can be converted to type <typeparamref name="T"/>.
            /// </returns>
        ...
        /// <summary>
        /// Provides non-generic, cached utilities for specified types.
        /// </summary>
        private static class TypeInfo
        {
            /// <summary>
            /// The locker that synchronizes access to <see cref="CanBeConvertedToDict"/>.
            /// </summary>
            ...
            /// </returns>
            /// <remarks>Calls <see cref="TypeInfo{TypeInfo}.CanBeInitializedFrom"/>.</remarks>
