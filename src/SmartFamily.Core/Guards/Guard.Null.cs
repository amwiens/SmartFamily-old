...
namespace SmartFamily.Core.Guards
{
    ...
    public static partial class Guard
    {
        ...
        /// <summary>
        /// Requires the nullable argument to be <c>null</c>.
        /// </summary>
        /// <typeparam name="T">The type of the argument.</typeparam>
        /// <param name="argument">The argument.</param>
        /// <param name="message">
        ...
        /// <summary>
        /// Requires the argument not to be <c>null</c>.
        /// </summary>
        /// <typeparam name="T">The type of the argument.</typeparam>
        /// <param name="argument">The argument.</param>
        /// <param name="message">
        ...
        /// <summary>
        /// Requires the nullable argument not to be <c>null</c>.
        /// </summary>
        /// <typeparam name="T">The type of the argument.</typeparam>
        /// <param name="argument">The argument.</param>
        /// <param name="message">
        ...
        /// <summary>
        /// Requires at least one of the specified arguments not to be <c>null</c>.
        /// </summary>
