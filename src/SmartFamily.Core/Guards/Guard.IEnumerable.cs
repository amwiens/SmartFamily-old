...
{
    /// <content>
    /// Provides preconditions for <see cref="IEnumerable"/> arguments.
    /// </content>
    public static partial class Guard
    {
        ...
        /// <param name="argument">The collection argument.</param>
        /// <param name="item">The item that the argument value is required not to contain.</param>
        /// <param name="comparer">The quality comparer to use.</param>
        /// <param name="message">
        ///     The factory to initialize the message of the exception that will be thrown if the
        ///     precondition is not satisfied.
        /// </param>
        ...
        /// <summary>
        /// Requires the specified collection to contain the argument value.
        /// </summary>
        /// <typeparam name="TCollection">The type of the collection.</typeparam>
        ...
        /// <summary>
        /// Requires the specified items to contain the argument value.
        /// </summary>
        /// <typeparam name="TItem">The type of the argument.</typeparam>
        /// <param name="argument">The argument.</param>
        /// <param name="items">The items that are required to contain the argument value.</param>
        /// <returns><paramref name="argument"/></returns>
        /// <exception cref="ArgumentException">
        ...
        /// <summary>
        /// Requires the specified collection not to contain the argument value.
        /// </summary>
        /// <typeparam name="TCollection">The type of the collection.</typeparam>
        /// <typeparam name="TItem">The type of the argument.</typeparam>
        /// <param name="argument">The argument.</param>
        ...
        /// <summary>
        /// Requires the specified items not to contain the argument value.
        /// </summary>
        /// <typeparam name="TItem">The type of the argument.</typeparam>
        /// <param name="argument">The argument.</param>
        ...
        /// <summary>
        /// Provides cached, non-generic collection utilities.
        /// </summary>
        ...
        /// <summary>
        /// Provides cached collection utilities for the type <typeparamref name="TCollection"/>.
        /// </summary>
        /// <typeparam name="TCollection">The type of the collection.</typeparam>
            ...
            where TCollection : IEnumerable?
        {
            ...
            /// <summary>
            /// Initializes <see cref="ContainsNull"/>.
            /// </summary>
            /// <returns></returns>
            ...
            /// <summary>
            /// Initializes <see cref="ContainsDuplicate"/>.
            /// </summary>
            /// <returns>
            ///     A function that returns a value that indicates whether the specified collection
            ...
            /// <summary>
            /// Returns the item type of a generic <typeparamref name="TCollection"/>.
            /// </summary>
            /// <returns>
