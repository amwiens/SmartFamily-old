...
{
    /// <content>
    /// Provides preconditions for <see cref="IEquatable{T}"/> arguments.
    /// </content>
    public static partial class Guard
    {
        /// <summary>
        /// Requires the argument to have the default value of type <typeparamref name="T"/>.
        /// </summary>
        ...
        /// <summary>
        /// Requires the argument to have the specified value.
        /// </summary>
        /// <typeparam name="T">The type of the equatable argument.</typeparam>
        /// <param name="argument">The equatable argument.</param>
        ...
        /// <summary>
        /// Requires the argument to have the same reference as the specified object.
        /// </summary>
