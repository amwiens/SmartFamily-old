...
{
    /// <content>
    /// Provides scoping support.
    /// </content>
    public static partial class Guard
    {
        /// <summary>
        /// Starts a guarding scope using the specified exception interceptor.
        /// </summary>
        ...
        private sealed class Scope : IDisposable
        {
            ...
            /// <summary>
            /// Gets the current guarding scope.
            /// </summary>
        ...
        /// <summary>
        /// Provides helpers to create disposables.
        /// </summary>
        private static class Disposable
        {
            /// <summary>
            /// Gets an instance that does nothing when disposed.
            /// </summary>
