...
namespace SmartFamily.WinUI.UserControls.ActionBlocks;
...
public sealed partial class ActionBlockControl : UserControl
{
    ...
    public static readonly DependencyProperty ExpanderContentProperty =
        DependencyProperty.Register(nameof(ExpanderContent), typeof(FrameworkElement), typeof(ActionBlockContentControl), new PropertyMetadata(null));
